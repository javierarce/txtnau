...
module.exports = class HTML {
  ...
  build () {
    fs.readFile(`${__dirname}/../tweets.txt`, (err, data) => {
      if (err) {
        throw err;
      }
